...
describe(MODEL_ID, () => {
    test('caps and values responses triggers config publish', (t) => {
        ...
        assert.equal(components.compressorfrequency.entity_category, undefined)
        ...
        assert.equal(components.energyaccumulated.entity_category, undefined)
        ...
        assert.equal(components.energytotal.entity_category, undefined)
        assert.ok(components.odusuctiontemp, 'ODU suction temperature sensor')
        assert.equal(components.odusuctiontemp.entity_category, undefined)
        assert.equal(components.oduhextemp.entity_category, undefined)
        assert.equal(components.oduairtemp.entity_category, undefined)
        assert.equal(components.eev.entity_category, undefined)
        assert.equal(components.fanrpm.entity_category, undefined)
        ...
        assert.equal(components.autodry.entity_category, 'config')
        assert.equal(components.autodry.optimistic, undefined, 'switch uses reported device state')
        assert.equal(components.sleeptimer.entity_category, 'config')
        assert.equal(components.starttimer.entity_category, undefined)
        assert.equal(components.stoptimer.entity_category, undefined)
