...
| -----: | ------------------ | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
|     27 | `1`, `3`           | Fridge temperature-maintenance result candidate; possibly `3=above target/cooling`, `1=maintained`                   | Provisional mapping                                                        |
|     28 | `3 -> 1` overnight | Freezer temperature-maintenance result candidate; possibly `3=above target/cooling`, `1=maintained`                  | Provisional mapping; fridge/freezer naming still needs independent capture |
...
| Fridge temperature-maintenance status             | `status[27]`                                   | Provisional                                               | Read-only text sensor; `1=maintained`, `3=above target/cooling`, other raw values preserved                     |
| Freezer temperature-maintenance status            | `status[28]`                                   | Provisional                                               | Read-only text sensor; fridge/freezer naming needs independent capture                                          |
